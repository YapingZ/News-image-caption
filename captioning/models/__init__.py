...
from .myTransformerModel import MyTransformerModel
...
def setup(opt):
    ...
    elif opt.caption_model == 'news_caption':
        model = NewsAttModel(opt)
    elif opt.caption_model == 'news_fusion_caption':
        model = News_fusion_AttModel(opt)
    elif opt.caption_model == 'news_type_fusion_caption':
        model = News_type_fusion_AttModel(opt)
    elif opt.caption_model == 'mytransformer':
        model = MyTransformerModel(opt)
    # Transformer
