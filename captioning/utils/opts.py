...
def if_use_feat(caption_model):
    ...
    elif caption_model in ['updown', 'topdown','news_caption','mytransformer']:
        use_fc, use_att = True, True
    elif caption_model in ['news_fusion_caption','mytransformer_fusion', 'news_type_fusion_caption']:
        use_fc, use_att, use_spacial = True, True, True
    else:
        use_att, use_fc = True, False
    return use_fc, use_att, use_spacial
...
def parse_opt():
    ...
    # my setting
    parser.add_argument('--add_news_type', type=float, default=0,
                        help='')
    parser.add_argument('--input_news_class', type=str, default='',
                        help='path to the json file containing additional info and vocab. empty = fetch from model checkpoint.')
    parser.add_argument('--use_news_type', action='store_true',
                        help='')
    parser.add_argument('--rollout_flag', type=int, default=-1,
                        help='T')
    ...
    parser.add_argument('--nkpe_reward_weight', type=float, default=0,
                        help='The reward weight from bleu4')
    ...
    args.use_fc, args.use_att, args.use_spacial = if_use_feat(args.caption_model)
...
def add_eval_options(parser):
    ...
    parser.add_argument('--input_att_dir', type=str, default='',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_spacial_dir', type=str, default='',
                        help='path to the h5file containing the preprocessed dataset')
