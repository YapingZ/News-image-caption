...
def main(params):
    ...
    for i_t in imgs_train:
        i_t['split'] = 'train'
        i_t[
            'file_path'] = '/home/ps/jinfei/workspace/self-critical.pytorch-master/data/news_annotations/images/train2017/'
    imgs_valid = json.load(open(params['input_json_1'], 'r'))
    ...
    imgs_test = json.load(open(params['input_json_2'], 'r'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json_1', default='data/dataset_coco.json', help='input json file to process into hdf5')
    parser.add_argument('--input_json_2', default='data/dataset_coco.json', help='input json file to process into hdf5')
