...
replace = ['input_fc_dir', 'input_att_dir', 'input_box_dir', 'input_spacial_dir', 'input_label_h5', 'input_json', 'batch_size', 'id']
ignore = ['start_from']
...
result_fn = os.path.join('eval_results/', opt.id + '_rl'  + opt.split + '.json')
